...
namespace PaperProcessor.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public MaterialsController(PaperProcessorContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaterialId,Name,Unit,CostPerUnit")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaterialId,Name,Unit,CostPerUnit")] Material material)
        {
